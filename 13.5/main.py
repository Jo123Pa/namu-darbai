...
from  Mokymas.modules import kursas
from  Mokymas.modules import _kursas

def main():
    print(kursas.Kursas('Python', 'Tadas', 'valanda').destyti())
    print(_kursas.PythonKursas('Python', 'Tadas', 'valanda').destyti())
